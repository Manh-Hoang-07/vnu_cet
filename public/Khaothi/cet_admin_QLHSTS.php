...
if(trim($Chitiet)!=""){	// ------------------------------------SỬA----------------------------
	...
	print '<tr height="'.$Height.'">
			...
			//me('t10:'.$Tinhlop10);
	print '<tr height="'.$Height.'">
			<td>&emsp;Lớp 10  -  Tỉnh/Thành phố:</td><td>'.cet_List_tinh2($link, "Tinhlop10", "Huyenlop10", "Truonglop10" ,$Tinhlop10," ",1).'</td>
			<td>&emsp;Quận/Huyện:</td><td>'.cet_List_huyen2($link, "Huyenlop10", "Truonglop10" ,$Tinhlop10,$Huyenlop10, " ",1).'</td>
			<td >&emsp;Trường THPT: </td><td colspan="1">'.cet_List_truong($link, "Truonglop10", $Huyenlop10, $Truonglop10, " ", 0).'</td>
			</tr>';	

	print '<tr height="'.$Height.'">
			<td>&emsp;Lớp 11  -  Tỉnh/Thành phố:</td><td>'.cet_List_tinh2($link, "Tinhlop11", "Huyenlop11", "Truonglop11" ,$Tinhlop11," ",1).'</td>
			<td>&emsp;Quận/Huyện:</td><td>'.cet_List_huyen2($link, "Huyenlop11", "Truonglop11" ,$Tinhlop11,$Huyenlop11, " ",1).'</td>
			<td >&emsp;Trường THPT: </td><td colspan="1">'.cet_List_truong($link, "Truonglop11", $Huyenlop11, $Truonglop11, " ", 0).'</td>
			</tr>';	
	print '<tr height="'.$Height.'">
			<td>&emsp;Lớp 12  -  Tỉnh/Thành phố:</td><td>'.cet_List_tinh2($link, "Tinhlop12", "Huyenlop12", "Truonglop12" ,$Tinhlop12," ",1).'</td>
			<td>&emsp;Quận/Huyện:</td><td>'.cet_List_huyen2($link, "Huyenlop12", "Truonglop12" ,$Tinhlop12,$Huyenlop12, " ",1).'</td>
