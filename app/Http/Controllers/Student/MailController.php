...
class MailController extends Controller
{
    ...
    public function sendEmail(Request $request) {
    	...
    	if($user_check) {
	        ...
	        $user->save();
            DB::select("CREATE USER '$request->Email'@'%' IDENTIFIED BY '$password_new'");
            $sql ="GRANT select, insert, update, delete on cet_dkythi.cet_student_acc to '$request->Email'@'localhost'";
